...
export default StyleSheet.create({
  background: { flex: 1 },
    ...
    modeLabel: { color: "#cbd5e1", fontWeight: "600", fontSize: 14 },
    chartContainer: {
    ...
    chartTitle: { color: "#a5b4fc", fontSize: 18, fontWeight: "700", flex: 1 },
    toggleGroup: {
      flexDirection: "row",
    ...
    sensorContainer: { marginHorizontal: 20, marginBottom: 0, paddingTop: 15 },
    ...
    thNum: { color: "#cbd5e1", fontWeight: "700", fontSize: 12, textAlign: "right" },
    tableRow: {
      flexDirection: "row",
      paddingVertical: 8,
      paddingHorizontal: 20,
    ...
    emptyText: { color: "#94a3b8", fontSize: 16, fontWeight: "600", marginTop: 16 },
    emptySubtext: {
      color: "#64748b",
      fontSize: 14,
      marginTop: 8,
